...
if (isset($_FILES['archivo'])) {
    ...
    $carpeta_destino = "../assets/doc/$oficina/$unidad/$anio/";
    ...
    if (!file_exists($carpeta_destino)) {
        ...
        if (mkdir($carpeta_destino, 0777, true)) {
            ...
            header("location: ../reginventario.php");
            exit;
        }
    } else {
    ...
    if ($extension == "pdf" || $extension == "xlsx" || $extension == "docx") {
        ...
        if (move_uploaded_file($_FILES["archivo"]["tmp_name"], $carpeta_destino . $nombre_cambio)) {
            ...
            subirArchiv($con, $nombre, $descripcion, $oficina, $unidad, $anio, $nombre_cambio);
            header("location: ../reginventario.php");
        } else {
            echo "<script language='JavaScript'>
            alert('Error al subir el archivo. ');
            location.assign('../reginventario.php');
            </script>";
        }
    } else {
        echo "<script language='JavaScript'>

...
<header class="header">
    ...
    <section class="register_docs">
     <a href="docscaneados.php">Registrar nuevo documento</a>
     </section>
    

    <table class="table table-bordered cell-border compact row-border " id="dataTable" width="90%" cellspacing="1">
        <thead>
            <tr>
                <th>#</th>
                <th>Usuario</th>
        ...
        <tbody>
            ...
            $consulta = mysqli_query($con, "SELECT * FROM documento");
